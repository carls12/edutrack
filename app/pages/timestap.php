        ...
        <div class="d-flex align-items-start justify-content-between flex-wrap gap-3">
          <div class="d-flex align-items-center gap-3">
            ...
            <div>
              ...
              <div class="text-muted timestap-subtitle">Use your teacher code and the current 6-digit office security code. If needed, the office can also issue a temporary fallback code.</div>
            </div>
          </div>
          ...
          <div class="card-body p-4 p-lg-5">
            ...
            <div class="timestap-steps">
              <div class="timestap-step">
                ...
                <div>Ask the office for the current 6-digit security code or, if necessary, a temporary fallback code.</div>
              </div>
              <div class="timestap-step">
